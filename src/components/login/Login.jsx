  ...
  return (
    <div className="login">
      ...
      <div className="loginLogo">
        <svg viewBox="0 0 111 30" class="svg-icon" focusable="false">
          <g id="netflix-logo">
            <path
      ...
      <div className="loginContainer">
        ...
        <div>
          <button className="loginSigin">sign In</button>
        ...
        <div className="loginContainerFooter">
          ...
          <div className="loginCaptcha">
            ...
            bot.{" "}
            <a href="#" className="loginLearnmore">
              Learn more.
            </a>
          </div>
        </div>
